...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _module_app__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./module/app */ \"./src/module/app.js\");\n\n\n\nconst form = document.getElementById('form');\n\nconst todo = new _module_app__WEBPACK_IMPORTED_MODULE_1__[\"default\"]();\n\nconst createTask = () => {\n  form.addEventListener('submit', (e) => {\n    e.preventDefault();\n    const description = form.elements.desc.value;\n    todo.addTodo(description);\n    todo.displayTodo();\n    form.reset();\n  });\n\n  if (localStorage.getItem('todo')) {\n    todo.displayTodo();\n  }\n\n};\n\ncreateTask();\n\n\n//# sourceURL=webpack://todo-list/./src/index.js?");
